...
(function ($) {
  ...
  versionSelect.on("change", function () {
    ...
    if (this.value === "light") {
      ...
      setCookie("logo_src2", "public/images/logo-text-white.png");
    }
